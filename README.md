...
|`felddy/foundryvtt:13.346`| The most recent image matching the major and minor version numbers. |
|`felddy/foundryvtt:13.346.0`| An exact image version. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `13.346` |
...
```console
docker build \
  --tag felddy/foundryvtt:13.346.0 \
