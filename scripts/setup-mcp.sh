...
echo ""
echo "If a tool later reports 'Foundry VTT module not connected', the backend"
echo "is usually fine and the browser hop is down. Diagnose with:"
echo "  ./scripts/mcp-health.sh   # pins the failing hop + browser recovery steps"
echo ""
echo "Before anything risky, snapshot the Foundry data dir — see"
echo "  docs/PROJECT.md, 'Testing changes against the live stack'."
